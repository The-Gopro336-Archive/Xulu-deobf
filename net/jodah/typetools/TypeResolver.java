...
public final class TypeResolver {
   ...
   public static Class resolveRawArgument(Type var0, Class var1) {
      ...
      if (var2 == null) {
         ...
         throw new IllegalArgumentException(String.valueOf((new StringBuilder()).append("Expected 1 argument for generic type ").append(var0).append(" but found ").append(var2.length)));
      } else {
         return var2[0];
      }
   }
   ...
   public static Class[] resolveRawArguments(Type var0, Class var1) {
      ...
      if (var0 instanceof ParameterizedType) {
         ...
         Type[] var5 = var8.getActualTypeArguments();
         ...
         TypeVariable[] var9 = ((Class)var0).getTypeParameters();
         var2 = new Class[var9.length];

         for(int var10 = 0; var10 < var9.length; ++var10) {
            var2[var10] = resolveRawClass(var9[var10], var1, var3);
         }
      }
