...
public class NumberUtils {
   ...
   public static Short createShort(String var0) {
      return var0 == null ? null : Short.valueOf(var0);
   }
   ...
   public static Number createNumber(String var0) throws NumberFormatException {
      if (var0 == null) {
         ...
         if (var2 > 0) {
            ...
            if (var4 <= 16 && (var4 != 16 || var21 <= '7')) {
               return (Number)(var4 <= 8 && (var4 != 8 || var21 <= '7') ? createInteger(var0) : createLong(var0));
            } else {
            ...
            if (var7 <= -1) {
               if (var8 > -1) {
                  if (var8 > var0.length()) {
                     throw new NumberFormatException(String.valueOf((new StringBuilder()).append(var0).append(" is not a valid number.")));
                  }
            ...
            if (!Character.isDigit(var21) && var21 != '.') {
               ...
               boolean var25 = isAllZeros(var22) && isAllZeros(var6);
               switch(var21) {
               case 'D':
               case 'd':
                  break;
               ...
               case 'L':
               case 'l':
                  if (var23 == null && var6 == null && (var24.charAt(0) == '-' && isDigits(var24.substring(1)) || isDigits(var24))) {
                     try {
               ...
               try {
                  ...
                  if (!var11.isInfinite() && ((double)var11.floatValue() != 0.0D || var25)) {
                     return var11;
                  }
               ...
               if (var23 == null && var6 == null) {
                  ...
                  boolean var9 = isAllZeros(var22) && isAllZeros(var6);
   ...
   private static void validateArray(Object var0) {
      if (var0 == null) {
         ...
         Validate.isTrue(Array.getLength(var0) != 0, "Array cannot be empty.", new Object[0]);
      }
   }
