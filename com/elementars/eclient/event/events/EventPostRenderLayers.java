...
public class EventPostRenderLayers extends Event {
   ...
   public EventPostRenderLayers(RenderLivingBase var1, ModelBase var2, EntityLivingBase var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      this.renderer = var1;
      this.modelBase = var2;
      this.entity = var3;
      this.limbSwing = var4;
