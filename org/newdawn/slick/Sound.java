...
public class Sound {
   ...
   public Sound(InputStream var1, String var2) throws SlickException {
      SoundStore.get().init();
      ...
      try {
         ...
         throw new SlickException(String.valueOf((new StringBuilder()).append("Failed to load sound: ").append(var2)));
      }
   }
