...
public class ParticleIO {
      ...
      if (var0 != null) {
         ...
         if (var2 != null && var2.length() != 0) {
            if (var2.equals("simple")) {
               ...
               Log.warn(String.valueOf((new StringBuilder()).append("unkown type detected: ").append(var2)));
            }
            ...
            Log.warn(String.valueOf((new StringBuilder()).append("problems reading element, skipping: ").append(var0)));
         }
   ...
   private static Element createRangeElement(Document var0, String var1, ConfigurableEmitter.Range var2) {
      ...
      var3.setAttribute("min", String.valueOf((new StringBuilder()).append("").append(var2.getMin())));
      var3.setAttribute("max", String.valueOf((new StringBuilder()).append("").append(var2.getMax())));
      var3.setAttribute("enabled", String.valueOf((new StringBuilder()).append("").append(var2.isEnabled())));
      return var3;
   }
   ...
   public static void saveConfiguredSystem(OutputStream var0, ParticleSystem var1) throws IOException {
      try {
         ...
         var4.setAttribute("additive", String.valueOf((new StringBuilder()).append("").append(var1.getBlendingMode() == 1)));
         var4.setAttribute("points", String.valueOf((new StringBuilder()).append("").append(var1.usePoints())));
   ...
   private static Element emitterToElement(Document var0, ConfigurableEmitter var1) {
      ...
      for(int var5 = 0; var5 < var4.size(); ++var5) {
         ...
         var7.setAttribute("offset", String.valueOf((new StringBuilder()).append("").append(var6.pos)));
         var7.setAttribute("r", String.valueOf((new StringBuilder()).append("").append(var6.col.r)));
         var7.setAttribute("g", String.valueOf((new StringBuilder()).append("").append(var6.col.g)));
         var7.setAttribute("b", String.valueOf((new StringBuilder()).append("").append(var6.col.b)));
   ...
   private static Element createValueElement(Document var0, String var1, ConfigurableEmitter.Value var2) {
      ...
      if (var2 instanceof ConfigurableEmitter.SimpleValue) {
         ...
         var3.setAttribute("value", String.valueOf((new StringBuilder()).append("").append(var2.getValue(0.0F))));
      } else if (var2 instanceof ConfigurableEmitter.RandomValue) {
         var3.setAttribute("type", "random");
         var3.setAttribute("value", String.valueOf((new StringBuilder()).append("").append(((ConfigurableEmitter.RandomValue)var2).getValue())));
      } else if (var2 instanceof ConfigurableEmitter.LinearInterpolator) {
         var3.setAttribute("type", "linear");
         var3.setAttribute("min", String.valueOf((new StringBuilder()).append("").append(((ConfigurableEmitter.LinearInterpolator)var2).getMin())));
         var3.setAttribute("max", String.valueOf((new StringBuilder()).append("").append(((ConfigurableEmitter.LinearInterpolator)var2).getMax())));
         var3.setAttribute("active", String.valueOf((new StringBuilder()).append("").append(((ConfigurableEmitter.LinearInterpolator)var2).isActive())));
         ...
         for(int var5 = 0; var5 < var4.size(); ++var5) {
            ...
            var7.setAttribute("x", String.valueOf((new StringBuilder()).append("").append(var6.x)));
            var7.setAttribute("y", String.valueOf((new StringBuilder()).append("").append(var6.y)));
            var3.appendChild(var7);
         }
      } else {
         Log.warn(String.valueOf((new StringBuilder()).append("unkown value type ignored: ").append(var2.getClass())));
      }
