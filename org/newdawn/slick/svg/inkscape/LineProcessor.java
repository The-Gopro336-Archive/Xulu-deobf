...
public class LineProcessor implements ElementProcessor {
   public void process(Loader var1, Element var2, Diagram var3, Transform var4) throws ParsingException {
      ...
      var13.addAttribute("x1", String.valueOf((new StringBuilder()).append("").append(var6)));
      var13.addAttribute("x2", String.valueOf((new StringBuilder()).append("").append(var8)));
      var13.addAttribute("y1", String.valueOf((new StringBuilder()).append("").append(var7)));
      var13.addAttribute("y2", String.valueOf((new StringBuilder()).append("").append(var9)));
