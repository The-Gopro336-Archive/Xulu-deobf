...
public class EllipseProcessor implements ElementProcessor {
   public void process(Loader var1, Element var2, Diagram var3, Transform var4) throws ParsingException {
      ...
      var12.addAttribute("cx", String.valueOf((new StringBuilder()).append("").append(var6)));
      var12.addAttribute("cy", String.valueOf((new StringBuilder()).append("").append(var7)));
      var12.addAttribute("rx", String.valueOf((new StringBuilder()).append("").append(var8)));
      var12.addAttribute("ry", String.valueOf((new StringBuilder()).append("").append(var9)));
