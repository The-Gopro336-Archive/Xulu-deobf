...
public class RectProcessor implements ElementProcessor {
   public void process(Loader var1, Element var2, Diagram var3, Transform var4) throws ParsingException {
      ...
      var12.addAttribute("width", String.valueOf((new StringBuilder()).append("").append(var6)));
      var12.addAttribute("height", String.valueOf((new StringBuilder()).append("").append(var7)));
      var12.addAttribute("x", String.valueOf((new StringBuilder()).append("").append(var8)));
      var12.addAttribute("y", String.valueOf((new StringBuilder()).append("").append(var9)));
