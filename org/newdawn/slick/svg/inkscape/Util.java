...
public class Util {
   ...
   static float getFloatAttribute(Element var0, String var1) throws ParsingException {
      ...
      try {
         ...
         throw new ParsingException(var0, String.valueOf((new StringBuilder()).append("Invalid value for: ").append(var1)), var4);
      }
   }
   ...
   static Transform getTransform(Element var0, String var1) {
      ...
      if (var2 == null) {
         ...
         var2 = var2.substring("translate(".length());
         ...
         var2 = var2.substring(0, var2.length() - 1);
         var2 = var2.substring("matrix(".length());
