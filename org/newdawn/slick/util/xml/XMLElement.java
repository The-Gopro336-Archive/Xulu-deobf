...
public class XMLElement {
   ...
   public int getIntAttribute(String var1) throws SlickXMLException {
      try {
         ...
         throw new SlickXMLException(String.valueOf((new StringBuilder()).append("Value read: '").append(this.getAttribute(var1)).append("' is not an integer")), var4);
      }
   }
   ...
   public int getIntAttribute(String var1, int var2) throws SlickXMLException {
      try {
         return Integer.parseInt(this.getAttribute(var1, String.valueOf((new StringBuilder()).append("").append(var2))));
      } catch (NumberFormatException var4) {
         throw new SlickXMLException(String.valueOf((new StringBuilder()).append("Value read: '").append(this.getAttribute(var1, String.valueOf((new StringBuilder()).append("").append(var2)))).append("' is not an integer")), var4);
      }
   }

   public double getDoubleAttribute(String var1, double var2) throws SlickXMLException {
      try {
         return Double.parseDouble(this.getAttribute(var1, String.valueOf((new StringBuilder()).append("").append(var2))));
      } catch (NumberFormatException var5) {
         throw new SlickXMLException(String.valueOf((new StringBuilder()).append("Value read: '").append(this.getAttribute(var1, String.valueOf((new StringBuilder()).append("").append(var2)))).append("' is not a double")), var5);
      }
   }

   public String toString() {
      String var1 = String.valueOf((new StringBuilder()).append("[XML ").append(this.getName()));
      String[] var2 = this.getAttributeNames();

      for(int var3 = 0; var3 < var2.length; ++var3) {
         var1 = String.valueOf((new StringBuilder()).append(var1).append(" ").append(var2[var3]).append("=").append(this.getAttribute(var2[var3])));
      }
   ...
   public boolean getBooleanAttribute(String var1, boolean var2) throws SlickXMLException {
      String var3 = this.getAttribute(var1, String.valueOf((new StringBuilder()).append("").append(var2)));
      if (var3.equalsIgnoreCase("true")) {
         return true;
      } else if (var3.equalsIgnoreCase("false")) {
         return false;
      } else {
         throw new SlickXMLException(String.valueOf((new StringBuilder()).append("Value read: '").append(this.getAttribute(var1, String.valueOf((new StringBuilder()).append("").append(var2)))).append("' is not a boolean")));
      }
   }
   ...
   public boolean getBooleanAttribute(String var1) throws SlickXMLException {
      ...
      if (var2.equalsIgnoreCase("true")) {
         ...
         throw new SlickXMLException(String.valueOf((new StringBuilder()).append("Value read: '").append(this.getAttribute(var1)).append("' is not a boolean")));
      }
   }
   ...
   public double getDoubleAttribute(String var1) throws SlickXMLException {
      try {
         ...
         throw new SlickXMLException(String.valueOf((new StringBuilder()).append("Value read: '").append(this.getAttribute(var1)).append("' is not a double")), var3);
      }
   }
   ...
   public String getContent() {
      ...
      for(int var3 = 0; var3 < var2.getLength(); ++var3) {
         if (var2.item(var3) instanceof Text) {
            var1 = String.valueOf((new StringBuilder()).append(var1).append(var2.item(var3).getNodeValue()));
         }
      }
