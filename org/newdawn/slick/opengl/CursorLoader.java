...
public class CursorLoader {
   ...
   public Cursor getCursor(String var1, int var2, int var3) throws LWJGLException, IOException {
   ...
   public Cursor getCursor(ImageData var1, int var2, int var3) throws LWJGLException, IOException {
