...
public class QuadBasedLineStripRenderer implements LineStripRenderer {
   ...
   public void start() {
      if (this.width == 1.0F) {
         ...
         this.cpt = 0;
         this.GL.flush();
         float[] var1 = this.GL.getCurrentColor();
   ...
   public void renderLinesImpl(float[] var1, int var2, float var3) {
      ...
      for(int var9 = 0; var9 < var2 + 1; ++var9) {
         ...
         if (var17 != 0.0F || var18 != 0.0F) {
            ...
            if (var9 != 0) {
               ...
               this.GL.glVertex3f(var5, var6, 0.0F);
               this.GL.glVertex3f(var7, var8, 0.0F);
               this.bindColor(var10);
               this.GL.glVertex3f(var13 + var18, var14 + var22, 0.0F);
               this.GL.glVertex3f(var13 - var18, var14 - var22, 0.0F);
            }
            ...
            if (var9 < var2 - 1) {
               ...
               this.GL.glVertex3f(var15 - var18, var16 - var22, 0.0F);
               this.GL.glVertex3f(var15 + var18, var16 + var22, 0.0F);
            }
         }
      }
      ...
      if (this.lineCaps) {
         ...
         if (var24 != 0.0F || var25 != 0.0F) {
            ...
            for(var27 = 0; (float)var27 < 180.0F + var23; var27 = (int)((float)var27 + var23)) {
               ...
               this.GL.glVertex2f(var1[0] + (float)(Math.cos((double)var14) * (double)var4), var1[1] + (float)(Math.sin((double)var14) * (double)var4));
            }
      ...
      if (this.lineCaps) {
         ...
         if (var24 != 0.0F || var25 != 0.0F) {
            ...
            for(var27 = 0; (float)var27 < 180.0F + var23; var27 = (int)((float)var27 + var23)) {
               var14 = (float)Math.toRadians((double)(var26 + (float)var27));
               this.GL.glVertex2f(var1[var2 * 2 - 2] + (float)(Math.cos((double)var14) * (double)var4), var1[var2 * 2 - 1] + (float)(Math.sin((double)var14) * (double)var4));
            }
   ...
   private void bindColor(int var1) {
      if (var1 < this.cpt) {
         if (this.renderHalf) {
            this.GL.glColor4f(this.colours[var1 * 4] * 0.5F, this.colours[var1 * 4 + 1] * 0.5F, this.colours[var1 * 4 + 2] * 0.5F, this.colours[var1 * 4 + 3] * 0.5F);
         } else {
