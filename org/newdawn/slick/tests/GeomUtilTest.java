...
public class GeomUtilTest extends BasicGame implements GeomUtilListener {
   ...
   public void render(GameContainer var1, Graphics var2) throws SlickException {
      ...
      var2.drawString(String.valueOf((new StringBuilder()).append("MODE: ").append(this.union ? "Union" : "Cut")), 530.0F, 200.0F);
      ...
      if (this.result != null) {
         ...
         var2.drawString(String.valueOf((new StringBuilder()).append("Polys:").append(this.result.length)), 10.0F, 100.0F);
         var2.drawString(String.valueOf((new StringBuilder()).append("X:").append(this.xp)), 10.0F, 120.0F);
         var2.drawString(String.valueOf((new StringBuilder()).append("Y:").append(this.yp)), 10.0F, 130.0F);
      }
