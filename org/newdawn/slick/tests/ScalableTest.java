...
public class ScalableTest extends BasicGame {
      ...
      try {
         ScalableGame var1 = new ScalableGame(new ScalableTest(), 1024, 568, true) {
            protected void renderOverlay(GameContainer var1, Graphics var2) {
               ...
               var2.drawString(String.valueOf((new StringBuilder()).append(var1.getInput().getMouseX()).append(",").append(var1.getInput().getMouseY())), 400.0F, 20.0F);
            }
         };
   ...
   public void render(GameContainer var1, Graphics var2) throws SlickException {
      ...
      var2.setColor(Color.white);
      var2.drawString(String.valueOf((new StringBuilder()).append(var1.getInput().getMouseX()).append(",").append(var1.getInput().getMouseY())), 10.0F, 400.0F);
