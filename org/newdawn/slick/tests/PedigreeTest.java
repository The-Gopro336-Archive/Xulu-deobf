...
public class PedigreeTest extends BasicGame {
   ...
   public void mousePressed(int var1, int var2, int var3) {
      super.mousePressed(var1, var2, var3);

      for(int var4 = 0; var4 < this.fire.getEmitterCount(); ++var4) {
         ((ConfigurableEmitter)this.fire.getEmitter(var4)).setPosition((float)(var2 - 400), (float)(var3 - 300), true);
      }
