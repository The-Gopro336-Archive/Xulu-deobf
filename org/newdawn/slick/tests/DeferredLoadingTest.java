...
public class DeferredLoadingTest extends BasicGame {
   ...
   public void update(GameContainer var1, int var2) throws SlickException {
      if (this.nextResource != null) {
         try {
            ...
            throw new SlickException(String.valueOf((new StringBuilder()).append("Failed to load: ").append(this.nextResource.getDescription())), var6);
         }
   ...
   public void render(GameContainer var1, Graphics var2) {
      if (this.nextResource != null) {
         var2.drawString(String.valueOf((new StringBuilder()).append("Loading: ").append(this.nextResource.getDescription())), 100.0F, 100.0F);
      }
