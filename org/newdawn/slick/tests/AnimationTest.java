...
public class AnimationTest extends BasicGame {
   ...
   public void render(GameContainer var1, Graphics var2) {
      ...
      var2.drawString(String.valueOf((new StringBuilder()).append("Til Limited animation: ").append(this.start)), 100.0F, 500.0F);
      var2.drawString("Hold 1 to move the manually animated", 100.0F, 70.0F);
      var2.drawString(String.valueOf((new StringBuilder()).append("PingPong Frame:").append(this.pingPong.getFrame())), 600.0F, 70.0F);
