...
public class ImageOutTest extends BasicGame {
   ...
   public void init(GameContainer var1) throws SlickException {
      ...
      try {
         ...
         throw new SlickException("Failed to load particle systems", var5);
      }
      ...
      for(int var3 = 0; var3 < var2.length; ++var3) {
         this.message = String.valueOf((new StringBuilder()).append(this.message).append(var2[var3]));
   ...
   private void writeTo(String var1) throws SlickException {
      ...
      this.message = String.valueOf((new StringBuilder()).append("Written ").append(var1));
   }
