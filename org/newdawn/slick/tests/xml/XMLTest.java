...
public class XMLTest {
   ...
   private static void assertEquals(Object var0, Object var1) {
      if (!var0.equals(var1)) {
         throw new RuntimeException(String.valueOf((new StringBuilder()).append("TEST FAILS: ").append(var0).append(" should be ").append(var1)));
      }
   }

   private static void assertNotNull(Object var0) {
      if (var0 == null) {
         throw new RuntimeException(String.valueOf((new StringBuilder()).append("TEST FAILS: ").append(var0).append(" must not be null")));
      }
   }
