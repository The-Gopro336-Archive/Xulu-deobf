...
public class ImageReadTest extends BasicGame {
   ...
   public void render(GameContainer var1, Graphics var2) {
      ...
      if (this.read[4] != null) {
         ...
         var2.drawString(String.valueOf((new StringBuilder()).append("On image: ").append(this.read[4].toString())), 100.0F, 250.0F);
      }

      if (this.read[5] != null) {
         var2.setColor(Color.white);
         var2.drawString(String.valueOf((new StringBuilder()).append("On screen: ").append(this.read[5].toString())), 100.0F, 270.0F);
      }
