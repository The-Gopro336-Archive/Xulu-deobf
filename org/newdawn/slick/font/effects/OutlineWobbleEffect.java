...
public class OutlineWobbleEffect extends OutlineEffect {
   ...
   private class WobbleStroke implements Stroke {
      ...
      public Shape createStrokedShape(Shape var1) {
         ...
         var1 = (new BasicStroke(OutlineWobbleEffect.this.getWidth(), 2, OutlineWobbleEffect.this.getJoin())).createStrokedShape(var1);
         ...
         for(float var12 = 0.0F; !var3.isDone(); var3.next()) {
            ...
            if (var15 >= var12) {
               for(float var16 = 1.0F / var15; var15 >= var12; var12 += OutlineWobbleEffect.this.detail) {
      ...
      private float randomize(float var1) {
         return var1 + (float)Math.random() * OutlineWobbleEffect.this.amplitude * 2.0F - 1.0F;
      }

      // $FF: synthetic method
      WobbleStroke(Object var2) {
         this();
      }
   }
}
