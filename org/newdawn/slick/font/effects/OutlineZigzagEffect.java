      ...
      public Shape createStrokedShape(Shape var1) {
         ...
         for(int var13 = 0; !var3.isDone(); var3.next()) {
            ...
            case 0:
               ...
               var12 = OutlineZigzagEffect.this.wavelength / 2.0F;
               continue;
            case 1:
               break;
            case 2:
            ...
            if (var16 >= var12) {
               for(float var17 = 1.0F / var16; var16 >= var12; ++var13) {
                  ...
                  if ((var13 & 1) == 0) {
                     var2.lineTo(var18 + OutlineZigzagEffect.this.amplitude * var15 * var17, var19 - OutlineZigzagEffect.this.amplitude * var14 * var17);
                  } else {
                     var2.lineTo(var18 - OutlineZigzagEffect.this.amplitude * var15 * var17, var19 + OutlineZigzagEffect.this.amplitude * var14 * var17);
                  }

                  var12 += OutlineZigzagEffect.this.wavelength;
               }
            }
         ...
         return (new BasicStroke(OutlineZigzagEffect.this.getWidth(), 2, OutlineZigzagEffect.this.getJoin())).createStrokedShape(var2);
      }
