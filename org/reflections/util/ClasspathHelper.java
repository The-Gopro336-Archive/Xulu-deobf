...
public abstract class ClasspathHelper {
   ...
   public static URL forClass(Class var0, ClassLoader... var1) {
      ...
      String var3 = String.valueOf((new StringBuilder()).append(var0.getName().replace(".", "/")).append(".class"));
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         try {
            ...
            if (Reflections.log != null) {
               Reflections.log.warn("Could not get URL", var11);
            }
         }
      }
   ...
   public static String cleanPath(URL var0) {
      ...
      if (var1.endsWith("!/")) {
         var1 = String.valueOf((new StringBuilder()).append(var1.substring(0, var1.lastIndexOf("!/"))).append("/"));
      }
   ...
   static URL tryToGetValidUrl(String var0, String var1, String var2) {
      try {
         ...
         if ((new File(String.valueOf((new StringBuilder()).append(var1).append(File.separator).append(var2)))).exists()) {
            return (new File(String.valueOf((new StringBuilder()).append(var1).append(File.separator).append(var2)))).toURI().toURL();
         }

         if ((new File(String.valueOf((new StringBuilder()).append(var0).append(File.separator).append(var2)))).exists()) {
            return (new File(String.valueOf((new StringBuilder()).append(var0).append(File.separator).append(var2)))).toURI().toURL();
         }
   ...
   public static Collection forResource(String var0, ClassLoader... var1) {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         try {
            ...
            if (Reflections.log != null) {
               Reflections.log.error(String.valueOf((new StringBuilder()).append("error getting resources for ").append(var0)), var11);
            }
         }
      }
