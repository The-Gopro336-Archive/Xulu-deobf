...
public class FilterBuilder implements Predicate {
   ...
   private FilterBuilder(Collection var1) {
   ...
   private static String packageNameRegex(Class var0) {
      return prefix(String.valueOf((new StringBuilder()).append(var0.getPackage().getName()).append(".")));
   }
   ...
   public static String prefix(String var0) {
      return String.valueOf((new StringBuilder()).append(var0.replace(".", "\\.")).append(".*"));
   }
   ...
   public static FilterBuilder parsePackages(String var0) {
      ...
      if (!Utils.isEmpty(var0)) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            ...
            String var8 = var6.substring(1);
            if (!var8.endsWith(".")) {
               var8 = String.valueOf((new StringBuilder()).append(var8).append("."));
            }
