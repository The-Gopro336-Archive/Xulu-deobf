...
public class JavaCodeSerializer implements Serializer {
   ...
   public String toString(Reflections var1) {
      ...
      for(Iterator var6 = var5.iterator(); var6.hasNext(); var3 = var8) {
         ...
         String var25 = (String)var8.get(var8.size() - 1);
         ...
         while(var16.hasNext()) {
            ...
            if (var17.startsWith("@")) {
               ...
               if (!var17.startsWith("<")) {
                  ...
                  String var21 = "";
                  if (var20.length() != 0) {
                     var21 = String.valueOf((new StringBuilder()).append("_").append(var20.replace(".", "_").replace(", ", "__").replace("[]", "$$")));
                  }

                  String var22 = String.valueOf((new StringBuilder()).append(var19).append(var21));
         ...
         var2.append(Utils.repeat("\t", var4++)).append("public interface ").append(this.getNonDuplicateName(var25, var8, var8.size() - 1)).append(" {\n");
         if (!var12.isEmpty()) {
         ...
         if (!var13.isEmpty()) {
            ...
            while(var16.hasNext()) {
               var17 = (String)var16.next();
               var26 = this.getNonDuplicateName(var17, var12);
               var2.append(Utils.repeat("\t", var4)).append("public interface ").append(this.getNonDuplicateName(var26, var8)).append(" {}\n");
            }
         ...
         if (!var11.isEmpty()) {
            ...
            while(var16.hasNext()) {
               var17 = (String)var16.next();
               var26 = this.getNonDuplicateName(var17, var8);
               var2.append(Utils.repeat("\t", var4)).append("public interface ").append(var26).append(" {}\n");
            }
      ...
      for(int var24 = ((List)var3).size(); var24 >= 1; --var24) {
         var2.append(Utils.repeat("\t", var24)).append("}\n");
      }
   ...
   private String getNonDuplicateName(String var1, List var2, int var3) {
      ...
      for(int var5 = 0; var5 < var3; ++var5) {
         if (var4.equals(var2.get(var5))) {
            return this.getNonDuplicateName(String.valueOf((new StringBuilder()).append(var4).append("_")), var2, var3);
         }
      }
   ...
   public static Class resolveClass(Class var0) {
      try {
         ...
         throw new ReflectionsException(String.valueOf((new StringBuilder()).append("could not resolve to class ").append(var0.getName())), var2);
      }
   }
   ...
   public static Method resolveMethod(Class var0) {
      ...
      try {
         ...
         throw new ReflectionsException(String.valueOf((new StringBuilder()).append("could not resolve to method ").append(var0.getName())), var7);
      }
   }
   ...
   public File save(Reflections var1, String var2) {
      ...
      try {
         ...
         var8.append("}\n");
         Files.write((new File(var3)).toPath(), String.valueOf(var8).getBytes(Charset.defaultCharset()), new OpenOption[0]);
         return var4;
   ...
   public static Field resolveField(Class var0) {
      try {
         ...
         throw new ReflectionsException(String.valueOf((new StringBuilder()).append("could not resolve to field ").append(var0.getName())), var3);
      }
   }
   ...
   public static Annotation resolveAnnotation(Class var0) {
      try {
         ...
         throw new ReflectionsException(String.valueOf((new StringBuilder()).append("could not resolve to annotation ").append(var0.getName())), var6);
      }
   }
