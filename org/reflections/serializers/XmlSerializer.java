...
public class XmlSerializer implements Serializer {
   ...
   public File save(Reflections var1, String var2) {
      ...
      try {
         ...
         throw new ReflectionsException(String.valueOf((new StringBuilder()).append("could not save to file ").append(var2)), var6);
      } catch (Throwable var7) {
         throw new RuntimeException(String.valueOf((new StringBuilder()).append("Could not save to file ").append(var2).append(". Make sure relevant dependencies exist on classpath.")), var7);
      }
   }
